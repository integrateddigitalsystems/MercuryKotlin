...
import com.ids.mercury.model.response.Activity
...
class AdapterActivityPackages(
    val items: ArrayList<Activity>,
    private val itemClickListener: RVOnItemClickListener
) :
    RecyclerView.Adapter<AdapterActivityPackages.VHItem>() {
    ...
    override fun onBindViewHolder(holder: VHItem, position: Int) {
        ...
        if(MyApplication.selectedActivityId==items[position].id)
